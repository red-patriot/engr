...
TEST(TestSIUnit, Simple2DVector) {
  Eigen::Vector<engr::Length, 2> expected = {3.4 * m, 5.6 * m};
...
TEST(TestSIUnit, Simple3DVector) {
  Eigen::Vector<engr::Force, 3> expected = {12 * engr::kilo(N), 500 * N, -4.67 * engr::kilo(N)};
...
TEST(TestSIUnit, Simple6DVector) {
  Eigen::Vector<double, 6> expected = {5,
                                       6,
                                       7,
                                       -8,
                                       1.23,
                                       0.57};
  Eigen::Vector<engr::Energy, 6> actual = {5 * J,
                                           6 * J,
                                           7 * J,
                                           -8 * J,
                                           1.23 * J,
