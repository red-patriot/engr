...
METRIC_LITERALS_TEST(MetersPerSecondSquared, engr::Acceleration, 0.4, 0.4 * meter / second2)
METRIC_LITERALS_TEST(MetersPerSecondCubed, engr::Jerk, 1.1, 1.1 * meter / second3)
...
METRIC_LITERALS_TEST(Pascals, engr::Pressure, 5.6e4, 5.6e4 * pascal)
